...
# Load merge file with raw data
dat <- read.csv("ewp.statrisk.data.raw.csv")
...
library(devtools)
install_github('christophergandrud/DataCombine')
library(DataCombine)
dat <- slide(dat[order(dat$country, dat$year),], "cou.s.d", GroupVar = "country", NewVar = "cou.s.d.1", slideBy = -1, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.s.d", GroupVar = "country", NewVar = "cou.s.d.2", slideBy = -2, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.s.d", GroupVar = "country", NewVar = "cou.s.d.3", slideBy = -3, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.s.d", GroupVar = "country", NewVar = "cou.s.d.4", slideBy = -4, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.f.d", GroupVar = "country", NewVar = "cou.f.d.1", slideBy = -1, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.f.d", GroupVar = "country", NewVar = "cou.f.d.2", slideBy = -2, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.f.d", GroupVar = "country", NewVar = "cou.f.d.3", slideBy = -3, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "cou.f.d", GroupVar = "country", NewVar = "cou.f.d.4", slideBy = -4, keepInvalid = TRUE)

#       i. Start by getting lags for those 9 years that don't leak across countries using 'slide'.
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.1", slideBy = -1, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.2", slideBy = -2, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.3", slideBy = -3, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.4", slideBy = -4, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.5", slideBy = -5, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.6", slideBy = -6, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.7", slideBy = -7, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.8", slideBy = -8, keepInvalid = TRUE)
dat <- slide(dat[order(dat$country, dat$year),], "pit.mag.max", GroupVar = "country", NewVar = "pit.mag.max.9", slideBy = -9, keepInvalid = TRUE)
